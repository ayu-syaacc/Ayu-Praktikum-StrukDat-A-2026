# node class untuk menyimpan data dan pointer ke anak kiri dan kanan
class Node:
...
# class BinaryTree untuk mengelola operasi pada binary tree
class BinaryTree:
    def __init__(self):
        self.root = None
    ...
    # metode untuk melakukan traversal preorder, inorder, dan postorder
    ...
    # metode untuk mendapatkan semua leaf nodes
